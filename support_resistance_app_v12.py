...
st.set_page_config(page_title="Support & Resistance / Fibonacci / MACD & RSI", layout="wide")
...
def render_header(
    ...
    parts = [
        ...
        f'<div class="info-sub">TF: {html.escape(tf_label)} | Durasi: {html.escape(duration_label)} | Last Close: {last_close:.2f}</div>',
    ]
...
with ctrl1:
    st.text_input(
        ...
        key="symbol_input",
        placeholder="Contoh: BBCA, TLKM, BMRI, DEWA",
    )
